/**
 * CITE Frame Generator - Professional Photo Framing Application
...
class FrameGenerator {
    ...
    showPreviewInterface() {
        // Only show preview section and hide instructions
        this.previewSection.classList.remove('hidden');
        this.instructions.classList.add('hidden');
        // Optionally scroll to previewSection for accessibility
    ...
    triggerDownload(blob) {
        try {
            ...
            const filename = 'computer-engineer-frame.png';
            link.href = url;
